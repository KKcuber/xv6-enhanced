...
main(int argc, char *argv[])
{
  ...
  9a:	7d258593          	addi	a1,a1,2002 # 868 <malloc+0xfa>
  9e:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 420:	46c50513          	addi	a0,a0,1132 # 888 <digits>
 424:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ec:	3a0b8b93          	addi	s7,s7,928 # 888 <digits>
 ...
 62c:	25890913          	addi	s2,s2,600 # 880 <malloc+0x112>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f4:	1b07b783          	ld	a5,432(a5) # 8a0 <freep>
 ...
 722:	00e6ea63          	bltu	a3,a4,736 <free+0x50>
{
 ...
 764:	14f73023          	sd	a5,320(a4) # 8a0 <freep>
}
 768:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 796:	10e53503          	ld	a0,270(a0) # 8a0 <freep>
 ...
 7be:	0e690913          	addi	s2,s2,230 # 8a0 <freep>
  if(p == (char*)-1)
 7c2:	5afd                	li	s5,-1
 7c4:	a88d                	j	836 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7c6:	00000797          	auipc	a5,0x0
 7ca:	0e278793          	addi	a5,a5,226 # 8a8 <base>
 7ce:	00000717          	auipc	a4,0x0
 7d2:	0cf73923          	sd	a5,210(a4) # 8a0 <freep>
 7d6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f8:	0aa73623          	sd	a0,172(a4) # 8a0 <freep>
      return (void*)(p + 1);
