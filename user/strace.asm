...
main(int argc, char *argv[])
{
  ...
  18:	83c58593          	addi	a1,a1,-1988 # 850 <malloc+0xea>
  1c:	4509                	li	a0,2
  1e:	00000097          	auipc	ra,0x0
  22:	65c080e7          	jalr	1628(ra) # 67a <fprintf>
    exit(1);
  26:	4505                	li	a0,1
  ...
  9a:	7ca58593          	addi	a1,a1,1994 # 860 <malloc+0xfa>
  9e:	4509                	li	a0,2
  a0:	00000097          	auipc	ra,0x0
  a4:	5da080e7          	jalr	1498(ra) # 67a <fprintf>
  exit(0);
  a8:	4501                	li	a0,0
...
putc(int fd, char c)
{
 ...
 3e6:	f66080e7          	jalr	-154(ra) # 348 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 418:	46c50513          	addi	a0,a0,1132 # 880 <digits>
 41c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e4:	3a0b8b93          	addi	s7,s7,928 # 880 <digits>
 ...
 624:	25890913          	addi	s2,s2,600 # 878 <malloc+0x112>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6ec:	1b07b783          	ld	a5,432(a5) # 898 <freep>
 ...
 71a:	00e6ea63          	bltu	a3,a4,72e <free+0x50>
{
 ...
 75c:	14f73023          	sd	a5,320(a4) # 898 <freep>
}
 760:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 78e:	10e53503          	ld	a0,270(a0) # 898 <freep>
 ...
 7b6:	0e690913          	addi	s2,s2,230 # 898 <freep>
  if(p == (char*)-1)
 7ba:	5afd                	li	s5,-1
 7bc:	a88d                	j	82e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7be:	00000797          	auipc	a5,0x0
 7c2:	0e278793          	addi	a5,a5,226 # 8a0 <base>
 7c6:	00000717          	auipc	a4,0x0
 7ca:	0cf73923          	sd	a5,210(a4) # 898 <freep>
 7ce:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f0:	0aa73623          	sd	a0,172(a4) # 898 <freep>
      return (void*)(p + 1);
 ...
 83e:	b76080e7          	jalr	-1162(ra) # 3b0 <sbrk>
  if(p == (char*)-1)
